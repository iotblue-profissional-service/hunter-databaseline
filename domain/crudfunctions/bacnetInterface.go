...
type BacnetInterface interface {
	GetGlobalId() string
	...
	GetBacnetConfigurations() *cervello.BacnetDeviceConfig
}

func MigrateToCervelloBacnetDevice(obj DeviceInterface) (cervello.Device, error) {
...
func ValidateBacnetDeviceEntity(obj DeviceInterface) error {
	if obj.GetGlobalId() == "" {
